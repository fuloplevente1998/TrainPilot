...
- **Current `main` source: TrainPilot 1.0.0 / Android versionCode 2674**, promoted in #66 and #68 at `5d22e1a166d4909320e8924e278ce9d47f6443c8`. Complete exercise Statistics open in the shared red-X modal from Progress; the Journal has only Workout Log and Progress tabs. Branch Release Gate #36240223904, including Chromium and signed test APK, and post-merge main Quick/Performance passed. No `v1.0.0` tag or GitHub Release has been created.
- **Last published stable binary: TrainPilot 1.7.7 / Android versionCode 2670**, preserved as GitHub Release `v1.7.7` with signed APK, source ZIP and SHA-256 manifest. The former 1.7.7 source baseline was `61b7d2008740ffd56d352736f10aa93ab8c2e08c`.
...
- **1.0.0 source promotion complete.** `versionName 1.0.0` and `versionCode 2674`; `com.repforge.app`, release signing identity, storage identifiers and upgrade-safe behavior remain unchanged. The private `TrainPilot-Archive/main` source snapshot is `4d6c4fe821ecd6c62058d914030ae16a70c716cf`; no new archive releases/tags were created.
