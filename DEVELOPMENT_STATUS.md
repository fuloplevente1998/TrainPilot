...
- **Active Phase 5:** #27, #41, #44; existing branch `feat/phase5-health-27`, draft [PR #40](https://github.com/fuloplevente1998/TrainPilot/pull/40), development version **1.7.2 / 2661**. #27 and portions of #41 have implementation and automated coverage; #44 is planned, not yet implemented.
- Prior Phase 5 Release Gate #153 and Quick #519 PASS, but subsequent physical-phone testing **did not approve** the global chevron behavior; white triangles remained. **No Phase 5 merge until a new signed APK passes a fresh phone test.** Earlier CI PASS does not guarantee the current planned scope is complete.
