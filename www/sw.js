...
const CORE=['./','./index.html','./styles.css','./health-dashboard-168.css','./global-uiux-177.css','./progress-177.css','./progress-anatomy-177.png','./manifest.json','./runtime-manifest.txt'];
