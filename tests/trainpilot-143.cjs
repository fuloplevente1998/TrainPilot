...
assert.equal(pkg.version,'1.6.1');assert.equal(src.version,'1.6.1');assert.equal(src.versionCode,2650);
assert.match(gradle,/versionCode\s+2650/);assert.match(gradle,/versionName\s+"1\.6\.1"/);assert.ok(sw.includes('trainpilot-v1481'));
console.log('PASS TrainPilot 2650 local-only gallery picker guards');
