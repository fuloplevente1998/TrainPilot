...
assert.match(gradle,/versionCode\s+2651/);assert.match(gradle,/versionName\s+"1\.6\.2"/);assert.ok(sw.includes('trainpilot-v1481'));
console.log('PASS TrainPilot 2651 local-only gallery picker guards');
