...
assert.equal(pkg.version,'1.7.3');assert.equal(meta.version,'1.7.3');assert.equal(meta.versionCode,2662);
assert.match(gradle,/versionCode\s+2662/);assert.match(gradle,/versionName\s+"1\.7\.3"/);assert.match(sw,/trainpilot-v1481/);
