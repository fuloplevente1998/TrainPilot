...
assert.equal(pkg.version,'1.7.1');assert.equal(meta.version,'1.7.1');assert.equal(meta.versionCode,2660);
assert.match(gradle,/versionCode\s+2660/);assert.match(gradle,/versionName\s+"1\.7\.1"/);assert.match(sw,/trainpilot-v1481/);
