...
assert.equal(pkg.version,'1.7.0');assert.equal(meta.version,'1.7.0');assert.equal(meta.versionCode,2659);
assert.match(gradle,/versionCode\s+2659/);assert.match(gradle,/versionName\s+"1\.7\.0"/);assert.match(sw,/trainpilot-v1481/);
