...
assert.equal(pkg.version,'1.7.6');assert.equal(meta.version,'1.7.6');assert.equal(meta.versionCode,2665);
assert.match(gradle,/versionCode\s+2665/);assert.match(gradle,/versionName\s+"1\.7\.6"/);assert.match(sw,/trainpilot-v177-ui1/);
