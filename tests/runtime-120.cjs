...
assert.equal(pkg.version,'1.6.7');assert.equal(meta.version,'1.6.7');assert.equal(meta.versionCode,2656);
assert.match(gradle,/versionCode\s+2656/);assert.match(gradle,/versionName\s+"1\.6\.7"/);assert.match(sw,/trainpilot-v1481/);
