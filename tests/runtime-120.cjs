...
assert.equal(pkg.version,'1.0.0');assert.equal(meta.version,'1.0.0');assert.equal(meta.versionCode,2671);
assert.match(gradle,/versionCode\s+2671/);assert.match(gradle,/versionName\s+"1\.0\.0"/);assert.match(sw,/trainpilot-v100-rc1/);
