...
assert.equal(pkg.version,'1.6.1');assert.equal(meta.version,'1.6.1');assert.equal(meta.versionCode,2650);
assert.match(gradle,/versionCode\s+2650/);assert.match(gradle,/versionName\s+"1\.6\.1"/);assert.match(sw,/trainpilot-v1481/);
