...
assert.equal(pkg.version,'1.7.7');assert.equal(meta.version,'1.7.7');assert.equal(meta.versionCode,2669);
assert.match(gradle,/versionCode\s+2669/);assert.match(gradle,/versionName\s+"1\.7\.7"/);assert.match(sw,/trainpilot-v177-ui3/);
