...
assert.equal(pkg.version,'1.6.6');assert.equal(meta.version,'1.6.6');assert.equal(meta.versionCode,2655);
assert.match(gradle,/versionCode\s+2655/);assert.match(gradle,/versionName\s+"1\.6\.5"/);assert.match(sw,/trainpilot-v1481/);
