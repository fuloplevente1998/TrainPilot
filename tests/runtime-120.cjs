...
assert.equal(pkg.version,'1.6.0');assert.equal(meta.version,'1.6.0');assert.equal(meta.versionCode,2649);
assert.match(gradle,/versionCode\s+2649/);assert.match(gradle,/versionName\s+"1\.6\.0"/);assert.match(sw,/trainpilot-v1481/);
