...
assert.equal(pkg.version,'1.7.4');assert.equal(meta.version,'1.7.4');assert.equal(meta.versionCode,2663);
assert.match(gradle,/versionCode\s+2663/);assert.match(gradle,/versionName\s+"1\.7\.4"/);assert.match(sw,/trainpilot-v1481/);
