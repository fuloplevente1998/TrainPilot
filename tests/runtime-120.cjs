...
assert.equal(pkg.version,'1.7.5');assert.equal(meta.version,'1.7.5');assert.equal(meta.versionCode,2664);
assert.match(gradle,/versionCode\s+2664/);assert.match(gradle,/versionName\s+"1\.7\.5"/);assert.match(sw,/trainpilot-v1481/);
