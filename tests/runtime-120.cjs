...
assert.equal(pkg.version,'1.6.3');assert.equal(meta.version,'1.6.3');assert.equal(meta.versionCode,2652);
assert.match(gradle,/versionCode\s+2652/);assert.match(gradle,/versionName\s+"1\.6\.2"/);assert.match(sw,/trainpilot-v1481/);
