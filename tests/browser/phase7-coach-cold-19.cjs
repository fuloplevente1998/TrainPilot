...
(async()=>{await new Promise(r=>server.listen(0,'127.0.0.1',r));let b;try{
 ...
 const result=await p.evaluate(async()=>{
  ...
  const names=['rf233CoachPlan','rf220Readiness','rf233TargetWorkout','rf233ExerciseAdvice','rf152Recommendation','rf220Hist','rf220WorkoutTime','rf220ExerciseStats','rf220ProgressRows','rf220CoachScreen','rf233CoachScreen','tp155R4OpenPanel'],stats={};
