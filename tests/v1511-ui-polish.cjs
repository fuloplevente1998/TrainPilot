...
assert.equal(pkg.version,'1.6.9');
assert.equal(src.version,'1.6.9');
assert.equal(src.versionCode,2658);
assert.match(gradle,/versionCode\s+2658/);
assert.match(gradle,/versionName\s+"1\.6\.9"/);
