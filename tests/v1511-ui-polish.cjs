...
assert.equal(pkg.version,'1.6.8');
assert.equal(src.version,'1.6.8');
assert.equal(src.versionCode,2657);
assert.match(gradle,/versionCode\s+2657/);
assert.match(gradle,/versionName\s+"1\.6\.8"/);
