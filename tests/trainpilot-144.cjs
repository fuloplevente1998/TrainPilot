...
assert.equal(src.versionCode,2658);assert.match(gradle,/versionCode\s+2658/);
console.log('PASS TrainPilot 2658 local gallery / MediaStore camera / queue isolation guards');
