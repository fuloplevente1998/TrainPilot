...
assert.equal(src.versionCode,2660);assert.match(gradle,/versionCode\s+2660/);
console.log('PASS TrainPilot 2660 local gallery / MediaStore camera / queue isolation guards');
