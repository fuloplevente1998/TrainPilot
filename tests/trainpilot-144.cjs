...
assert.equal(src.versionCode,2653);assert.match(gradle,/versionCode\s+2653/);
console.log('PASS TrainPilot 2653 local gallery / MediaStore camera / queue isolation guards');
