...
assert.equal(src.versionCode,2659);assert.match(gradle,/versionCode\s+2659/);
console.log('PASS TrainPilot 2659 local gallery / MediaStore camera / queue isolation guards');
