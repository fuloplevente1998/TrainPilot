...
assert.equal(src.versionCode,2651);assert.match(gradle,/versionCode\s+2651/);
console.log('PASS TrainPilot 2651 local gallery / MediaStore camera / queue isolation guards');
