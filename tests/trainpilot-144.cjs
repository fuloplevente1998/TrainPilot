...
assert.equal(src.versionCode,2657);assert.match(gradle,/versionCode\s+2657/);
console.log('PASS TrainPilot 2657 local gallery / MediaStore camera / queue isolation guards');
