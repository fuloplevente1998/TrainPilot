...
assert.equal(src.versionCode,2652);assert.match(gradle,/versionCode\s+2652/);
console.log('PASS TrainPilot 2652 local gallery / MediaStore camera / queue isolation guards');
