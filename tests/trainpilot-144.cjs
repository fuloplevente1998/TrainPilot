...
assert.equal(src.versionCode,2656);assert.match(gradle,/versionCode\s+2656/);
console.log('PASS TrainPilot 2656 local gallery / MediaStore camera / queue isolation guards');
