...
assert.equal(pkg.version,'1.0.0');assert.equal(src.version,'1.0.0');assert.equal(src.versionCode,2674);assert.equal(src.baselineCommit,'d0a3881ed9d8ec9d1238a914b6e6cab5da1e7c3e');
assert.match(gradle,/versionCode\s+2674/);assert.match(gradle,/versionName\s+"1\.0\.0"/);
console.log('PASS Phase 7 #19 performance architecture + 1.0.0 metadata guards');
