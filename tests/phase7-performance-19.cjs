...
assert.equal(pkg.version,'1.7.4');assert.equal(src.version,'1.7.4');assert.equal(src.versionCode,2663);assert.equal(src.baselineCommit,'f064298ddbe1e7e4cf1ecdfca18b3d93899dc74a');
assert.match(gradle,/versionCode\s+2663/);assert.match(gradle,/versionName\s+"1\.7\.4"/);
console.log('PASS Phase 7 #19 performance architecture + 1.7.4 metadata guards');
