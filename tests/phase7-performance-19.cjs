...
assert.equal(pkg.version,'1.7.6');assert.equal(src.version,'1.7.6');assert.equal(src.versionCode,2665);assert.equal(src.baselineCommit,'d0a3881ed9d8ec9d1238a914b6e6cab5da1e7c3e');
assert.match(gradle,/versionCode\s+2665/);assert.match(gradle,/versionName\s+"1\.7\.6"/);
console.log('PASS Phase 7 #19 performance architecture + 1.7.6 metadata guards');
