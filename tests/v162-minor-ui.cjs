...
assert.equal(pkg.version,'1.7.3');assert.equal(src.version,'1.7.3');assert.equal(src.versionCode,2662);
...
console.log('PASS TrainPilot 1.7.3 release metadata + 1.6.3 regression guards');
