...
assert.equal(pkg.version,'1.6.7');assert.equal(src.version,'1.6.7');assert.equal(src.versionCode,2656);
assert.match(gradle,/versionCode\s+2656/);assert.match(gradle,/versionName\s+"1\.6\.7"/);
...
console.log('PASS TrainPilot 1.6.7 release metadata + 1.6.3 regression guards');
