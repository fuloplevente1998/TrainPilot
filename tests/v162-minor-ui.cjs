...
assert.equal(pkg.version,'1.6.6');assert.equal(src.version,'1.6.6');assert.equal(src.versionCode,2655);
assert.match(gradle,/versionCode\s+2655/);assert.match(gradle,/versionName\s+"1\.6\.6"/);
...
console.log('PASS TrainPilot 1.6.6 release metadata + 1.6.3 regression guards');
