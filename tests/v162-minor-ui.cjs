...
assert.equal(pkg.version,'1.7.4');assert.equal(src.version,'1.7.4');assert.equal(src.versionCode,2663);
...
console.log('PASS TrainPilot 1.7.4 release metadata + 1.6.3 regression guards');
