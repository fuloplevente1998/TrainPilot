...
assert.equal(pkg.version,'1.0.0');assert.equal(src.version,'1.0.0');assert.equal(src.versionCode,2674);
...
console.log('PASS TrainPilot 1.0.0 release metadata + 1.6.3 regression guards');
