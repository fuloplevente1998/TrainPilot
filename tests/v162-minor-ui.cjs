...
assert.equal(pkg.version,'1.6.5');assert.equal(src.version,'1.6.5');assert.equal(src.versionCode,2654);
assert.match(gradle,/versionCode\s+2654/);assert.match(gradle,/versionName\s+"1\.6\.5"/);
...
console.log('PASS TrainPilot 1.6.5 release metadata + 1.6.3 regression guards');
