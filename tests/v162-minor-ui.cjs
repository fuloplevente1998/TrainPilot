...
assert.equal(pkg.version,'1.6.4');assert.equal(src.version,'1.6.4');assert.equal(src.versionCode,2653);
assert.match(gradle,/versionCode\s+2653/);assert.match(gradle,/versionName\s+"1\.6\.4"/);
...
console.log('PASS TrainPilot 1.6.4 release metadata + 1.6.3 regression guards');
