...
assert.equal(pkg.version,'1.6.9');assert.equal(src.version,'1.6.9');assert.equal(src.versionCode,2658);
assert.match(gradle,/versionCode\s+2658/);assert.match(gradle,/versionName\s+"1\.6\.9"/);
...
console.log('PASS TrainPilot 1.6.9 release metadata + 1.6.3 regression guards');
